...
// Modifications by Maxim Saplin, 2022

// The original file copied from GitHub repo https://github.com/moneyeSir/flutter_text_selection_controls
...
class FlutterSelectionControls extends MaterialTextSelectionControls {
  ...
  /// Color of the surface used to draw options
  ...
  Widget buildToolbar(
    ...
    if (popupBackgroundColor != null) {
      w = Theme(
          data: Theme.of(context).copyWith(cardColor: popupBackgroundColor),
          child: w);
    }
...
class __SelectionToolBarState extends State<_SelectionToolBar> {
  ...
  Widget build(BuildContext context) {
    /// GIVE OPTION TO SWITCH BETWEEN CUPERTINO AND MATERIAL TEXT SELECTION TOOL BAR TYPES
