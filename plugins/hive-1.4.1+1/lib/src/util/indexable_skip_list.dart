...
export 'package:hive/src/util/append_only_list_stub.dart'
    if (dart.library.io) 'package:hive/src/util/append_only_list.dart'
    if (dart.library.html) 'package:hive/src/util/append_only_list_stub.dart';
